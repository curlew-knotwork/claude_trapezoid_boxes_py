...
PRESETS: dict[str, dict] = {
    ...
    "dulcimer": {
        "mode": "instrument",
        "description": "Dulcimer instrument body. long=180, short=120, length=380, depth=90, "
                       "T=3mm. Rounded-trapezoid soundhole, hardware, kerfing.",
        "common": {
            "long": 180.0,
            "short": 120.0,
            "length": 380.0,
        ...
        "instrument": {
            "soundhole_type": "rounded-trapezoid",
            "soundhole_aspect": 0.6,
            "hardware": True,
            "kerfing": True,
        },
    },
    "tenor-guitar": {
        ...
        "instrument": {
            ...
            "hardware": True,
            "kerfing": True,
            "helmholtz_freq": 82.4,  # E2 — tenor guitar lowest string
        },
    },
}
...
def list_presets() -> None:
    """Print all preset names and descriptions."""
